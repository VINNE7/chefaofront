    ...
    <div className="min-h-screen w-screen flex justify-center items-center flex-col  bg-slate-800">
      ...
      >
        <div>
          ...
          <input
            className="block box-border w-full rounded border-solid border-1 border-white py-2 px-4 pl-7 text-sm"
            type="text"
            {...register("firstName")}
          />
        </div>
        ...
        <div>
          ...
          <input
            className="block box-border w-full rounded border-solid border-1 border-white py-2 px-4 mb-8  pl-7 text-sm "
            type="password"
            {...register("password")}
          />
        </div>
