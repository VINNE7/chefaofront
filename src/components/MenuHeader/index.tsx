      ...
      <div className="w-screen flex flex-col items-center ">
        <div className="w-screen flex items-center flex-col ">
          <div className="relative w-screen flex items-center flex-col bg-royaldark rounded-b-2xl shadow-md">
            ...
            <form
              action=""
              className="mt-2 text-center flex flex-col justify-center items-center gap-2"
            >
              <input
                type="text"
            ...
            {isEditable ? (
              <button
                className="text-sm font-bold text-green-400 border-b-2 leading-6  border-green-400 mb-4"
              ...
              <button
                className="text-sm font-bold text-cyberyellow border-b-2 leading-6  border-cyberyellow mb-4"
                onClick={() => setIsEditable((state) => !state)}
              >
                Editar informações
              </button>
